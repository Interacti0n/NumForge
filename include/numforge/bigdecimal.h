...
------------------------------------------------------------------------------------------------------------------------------
    ...
    median is exact for finite decimal inputs. Geometric mean accepts only
    non-negative values; harmonic mean accepts only positive values. Population
    variance and standard deviation divide by n and accept at least one value.
    Sample standard deviation divides by n - 1 and requires at least two values.
    Only final division and roots use the requested significant digits and
    rounding mode. Failure preserves result.
