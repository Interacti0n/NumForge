...
static const CalculatorFunction calculator_functions[] =
{
    ...
    { "median", 1, 0, CALCULATOR_FUNCTION_MEDIAN },
    { "geomean", 1, 0, CALCULATOR_FUNCTION_GEOMETRIC_MEAN },
    { "harmean", 1, 0, CALCULATOR_FUNCTION_HARMONIC_MEAN },
    { "variance", 1, 0, CALCULATOR_FUNCTION_VARIANCE },
    { "stdevp", 1, 0, CALCULATOR_FUNCTION_STANDARD_DEVIATION_POPULATION },
    { "stdev", 2, 0, CALCULATOR_FUNCTION_STANDARD_DEVIATION_SAMPLE },
